...
function initSettings() {
    ...
    if (!numCardsSelect || !saveBtn || !deckContainer) {
        console.error("Settings DOM missing");
        return;
    }
    loadSettings(numCardsSelect, bgColorSelect, deckContainer, saveBtn);
}

function loadSettings(numCardsSelect,bgColorSelect,deckContainer,saveBtn) {
